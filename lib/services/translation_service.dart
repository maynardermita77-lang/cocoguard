...
class TranslationService extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    ...
    'two_factor.title': {
      ...
      'fil': 'Dalawang-Hakbang na Pagpapatunay',
    },
    'two_factor.subtitle': {
      'en': 'Add an extra layer of security',
      'fil': 'Magdagdag ng karagdagang seguridad',
    },
    'two_factor.status': {
      'en': 'Current Status',
      'fil': 'Kasalukuyang Kalagayan',
    },
    ...
    'two_factor.how_it_works': {
      'en': 'How it works',
      'fil': 'Paano ito gumagana',
    },
    'two_factor.step1': {
      'en': 'When you login, a 6-digit code is sent to your email',
      'fil': 'Kapag nag-login ka, may 6-digit code na ipapadala sa iyong email',
    },
    'two_factor.step2': {
      'en': 'Enter the code to verify your identity',
      'fil': 'Ilagay ang code upang mapatunayan ang iyong pagkakakilanlan',
    },
    'two_factor.step3': {
      'en': 'Only you can access your account',
      'fil': 'Ikaw lang ang makaka-access sa iyong account',
    },
    'two_factor.enable_btn': {
      'en': 'Enable Two-Factor Auth',
      'fil': 'I-enable ang 2FA',
    },
    'two_factor.disable_btn': {
      'en': 'Disable Two-Factor Auth',
      'fil': 'I-disable ang 2FA',
    },
    'two_factor.disable_title': {
      'en': 'Disable 2FA?',
      'fil': 'I-disable ang 2FA?',
    },
    'two_factor.disable_confirm': {
      'en':
          'Are you sure you want to disable two-factor authentication? Your account will be less secure.',
      'fil':
          'Sigurado ka bang gusto mong i-disable ang 2FA? Magiging mas mahina ang seguridad ng iyong account.',
    },
    'two_factor.enabled_success': {
      'en': '2FA enabled successfully!',
      'fil': 'Matagumpay na na-enable ang 2FA!',
    },
    'two_factor.disabled_success': {
      'en': '2FA has been disabled',
      'fil': 'Na-disable na ang 2FA',
    },
    'two_factor.code_sent': {
      'en': 'Verification code sent to your email',
      'fil': 'Naipadala na ang verification code sa iyong email',
    },
    'two_factor.enter_code': {
      'en': 'Enter Verification Code',
      'fil': 'Ilagay ang Verification Code',
    },
    'two_factor.code_sent_desc': {
      'en': 'A 6-digit code has been sent to your registered email address.',
      'fil': 'Naipadala na ang 6-digit code sa iyong email address.',
    },
    'two_factor.enter_6_digit': {
      'en': 'Please enter the 6-digit code',
      'fil': 'Mangyaring ilagay ang 6-digit code',
    },
    'two_factor.verify_enable': {
      'en': 'Verify & Enable',
      'fil': 'Patunayan at I-enable',
    },
    'two_factor.login_title': {
      'en': 'Verify Your Identity',
      'fil': 'Patunayan ang Iyong Pagkakakilanlan',
    },
    'two_factor.verify_identity': {
      'en': 'Two-Factor Verification',
      'fil': 'Dalawang-Hakbang na Pagpapatunay',
    },
    'two_factor.code_sent_to_email': {
      'en':
          'A verification code has been sent to your registered email address.',
      'fil': 'Naipadala na ang verification code sa iyong email address.',
    },
    'two_factor.verify_btn': {'en': 'Verify Code', 'fil': 'Patunayan ang Code'},
    'two_factor.resend_code': {
      'en': 'Resend Code',
      'fil': 'Ipadala Muli ang Code',
    },
    'two_factor.back_to_login': {
      'en': 'Back to Login',
      'fil': 'Bumalik sa Login',
    },
    'two_factor.invalid_code': {
      'en': 'Invalid or expired code',
      'fil': 'Hindi wasto o nag-expire na ang code',
    },
    ...
    'delete_account.subtitle': {
      'en': 'Permanently delete your account',
      'fil': 'Permanenteng burahin ang iyong account',
    },
    'delete_account.warning': {
      'en':
          'This action is permanent and cannot be undone. All your data will be permanently deleted.',
      'fil':
          'Ang aksyon na ito ay permanente at hindi na mababawi. Lahat ng iyong data ay permanenteng mabubura.',
    },
    'delete_account.what_deleted': {
      'en': 'What will be deleted:',
      'fil': 'Ang mabubura:',
    },
    'delete_account.item_profile': {
      'en': 'Your profile and personal information',
      'fil': 'Ang iyong profile at personal na impormasyon',
    },
    'delete_account.item_scans': {
      'en': 'All scan history and images',
      'fil': 'Lahat ng scan history at mga larawan',
    },
    'delete_account.item_settings': {
      'en': 'App settings and preferences',
      'fil': 'Mga settings at preferences ng app',
    },
    'delete_account.item_feedback': {
      'en': 'Submitted feedback',
      'fil': 'Mga isinumiteng feedback',
    },
    'delete_account.password_label': {
      'en': 'Enter your password to confirm',
      'fil': 'Ilagay ang iyong password upang kumpirmahin',
    },
    ...
    'delete_account.enter_password': {
      ...
      'fil': 'Mangyaring ilagay ang iyong password',
    },
    'delete_account.must_confirm': {
      'en': 'Please confirm that you understand',
      'fil': 'Mangyaring kumpirmahin na naintindihan mo',
    },
    'delete_account.confirm_text': {
      'en':
          'I understand that this action is permanent and all my data will be deleted',
      'fil':
          'Naiintindihan ko na permanente ang aksyon na ito at mabubura ang lahat ng aking data',
    },
    'delete_account.final_title': {
      'en': 'Final Confirmation',
      'fil': 'Huling Kumpirmasyon',
    },
    'delete_account.final_message': {
      'en':
          'This is your last chance. Once deleted, your account and all data cannot be recovered.',
      'fil':
          'Ito na ang iyong huling pagkakataon. Kapag nabura na, hindi na mababawi ang iyong account at data.',
    },
    'delete_account.delete_btn': {
      'en': 'Delete My Account',
      'fil': 'Burahin ang Aking Account',
    },
    ...
    'feedback_history.empty': {
      'en': 'No feedback yet',
      'fil': 'Wala pang feedback',
    },
    'feedback_history.empty_desc': {
      'en': 'Your submitted feedback will appear here',
      'fil': 'Dito lalabas ang iyong mga isinumite na feedback',
    },
  };
}
